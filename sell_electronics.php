...
<body>
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($result1) {
                ...
                $query3 = "INSERT INTO electronics (`electronic_id`,`brand`, `type`, `condition`, `exchange_possible`,  `price`, `image_path`, `description`) VALUES ('$tmp', '$brand', '$type', '$condition', '$exchange', '$price', '$file_name', '$description')";
    ...
    <div class="container-fluid">
        ...
        <div class="container d-lg-flex flex-lg-row-reverse">
            <!-- Sell Electronics Modal -->
            <div class="container" id="sellElectronics">
                <div class="card mt-3 mx-auto">
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h5 class="card-title">Upload Electronics Details</h5>
                        </div>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" aria-label="Floating label select example" id="floatingSelect" name="brand">
                                ...
                                <div class="card-footer text-end">
                                    ...
                                    <input type="submit" id="submit" name="submit" value="Upload" class="btn btn-danger">
                                </div>
                            </div>
                        </form>
                    </div>
