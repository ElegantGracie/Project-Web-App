...
<head>
    ...
    <title>Sell Health and Beauty</title>
</head>
<body>
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($result1) {
                ...
                $query3 = "INSERT INTO health_beauty (`health_beauty_id`,`gender`, `type`, `condition`, `exchange_possible`,  `price`, `image_path`, `description`) VALUES ('$tmp', '$gender', '$type', '$condition', '$exchange', '$price', '$file_name', '$description')";
    ...
    <div class="container-fluid">
        ...
        <div class="container d-lg-flex flex-lg-row-reverse">
            ...
            <div class="container" id="sellHealthBeauty">
                <div class="card mt-3 mx-auto">
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h5 class="card-title">Upload Health & Beauty Details</h5>
                        </div>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="card-footer text-end">
                                    ...
                                    <input type="submit" id="submit" name="submit" class="btn btn-danger" value="Upload">
                                </div>
                            </div>
                        </form>
                    </div>
