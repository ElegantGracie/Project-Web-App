...
<body>
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($result1) {
                ...
                $query3 = "INSERT INTO computing_items (`computing_id`, `type`, `ram`, `condition`, `exchange_possible`,  `price`, `image_path`, `description`) VALUES ('$tmp', '$type', '$ram', '$condition', '$exchange', '$price', '$file_name', '$description')";
    ...
    <div class="container-fluid">
        ...
        <div class="container d-lg-flex flex-lg-row-reverse">
            <!-- Sell Computing -->
            <div class="container" id="sellComputing">
                <div class="card mt-3 mx-auto">
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h5 class="card-title">Upload Computing Details</h5>
                        </div>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                                    ...
                                    <div class="col-12 col-lg-8">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" aria-label="Floating label select example" id="floatingSelect" name="ram">
                                ...
                                <div class="card-footer text-end">
                                    ...
                                    <input type="submit" id="submit" class="btn btn-danger" value="Upload" name="submit">
                                </div>
                            </div>
                        </form>
                    </div>
