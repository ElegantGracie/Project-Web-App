...
<body>
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($result1) {
                ...
                $query3 = "INSERT INTO furnitures (`furniture_id`,`material`, `type`, `condition`, `exchange_possible`,  `price`, `image_path`, `description`) VALUES ('$tmp', '$material', '$type', '$condition', '$exchange', '$price', '$file_name', '$description')";
    ...
    <div class="container-fluid">
        ...
        <div class="container d-lg-flex flex-lg-row-reverse">
            <!-- Sell Furniture -->
            <div class="container" id="sellFurniture">
                <div class="card mt-3 mx-auto">
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h5 class="card-title" id="">Upload Furniture Details</h5>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" name="material" aria-label="Floating label select example" id="floatingSelect" required>
                                                        <option>Material</option>
                                                        <option value="wood">Wood</option>
                                                        <option value="plastic">Plastic</option>
                                                        <option value="others">Others</option>
                                                    </select>
                                                    <label for="material">Select</label>
                                                </div>
                                            
                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" name="type" aria-label="Floating label select example" id="floatingSelect" required>
                                                        <option>Type</option>
                                                ...
                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" name="condition" aria-label="Floating label select example" id="floatingSelect" required>
                                            ...
                                            <div class="col-6">
                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" name="exchange" aria-label="Floating label select example" id="floatingSelect" required>
                                                        <option>Exchange Possible?</option>
                                                ...
                                                <div class="mb-3 form-floating">
                                                    <input type="text" class="form-control" name="price" id="floatingInput" placeholder="90">
                                                    <label for="price">Expected Price</label>
                                                </div>

                                                <div class="mb-3 form-floating">
                                                    <input type="file" class="form-control" name="image" id="image" onchange="showPreview(event)" placeholder="link" accept="image/*" required>
