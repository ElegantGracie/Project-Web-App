...
<body>
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            $sql1 = "INSERT INTO services (`title`, `company`, `type`, `exchange_possible`,  `price`, `image_path`, `description`) VALUES ('$title', '$company', '$type', '$exchange', '$price', '$file_name', '$description')";
    ...
    <div class="container-fluid">
        ...
        <div class="container d-lg-flex flex-lg-row-reverse">
            <!-- Sell Services -->
            <div class="container" id="sellServices">
                <div class="card mt-3 mx-auto">
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h5 class="card-title">Upload Services Details</h5>
                        </div>
                                    ...
                                    <div class="col-12 col-lg-8">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="mb-3 form-floating">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="90" name="company_name">
