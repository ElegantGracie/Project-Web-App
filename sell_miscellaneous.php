...
<head>
    ...
    <title>Sell Miscellaneous</title>
</head>
<body>
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($result1) {
                ...
                $query3 = "INSERT INTO miscellaneous (`miscellaneous_id`,`title`, `material`, `size`, `exchange_possible`,  `price`, `image_path`, `description`) VALUES ('$tmp', '$title', '$material', '$size', '$exchange', '$price', '$file_name', '$description')";
    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 navbar-links">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn text-dark" href="products"><i class="fa-solid fa-cart-plus mx-2"></i>Products</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container d-lg-flex flex-lg-row-reverse">
            <!-- Sell Miscellaneous Modal -->
            <div class="container" id="sellMiscellaneous">
                <div class="card mt-3 mx-auto">
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h5 class="card-title">Upload Miscellaneous Details</h5>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3 form-floating">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="90" name="title">
                                                    <label for="title">Title</label>
                                                </div>
                                            
                                                <div class="mb-3 form-floating">
                                                    <input type="text" class="form-control" id="floatingInput" placeholder="90" name="material">
                                                    <label for="material">Material</label>
                                                </div>
                                            
                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" aria-label="Floating label select example" id="floatingSelect" name="size">
