...
<body>
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($result1) {
                ...
                $query3 = "INSERT INTO books (`book_id`,`genre`, `type`, `condition`, `exchange_possible`,  `price`, `image_path`, `description`) VALUES ('$tmp', '$genre', '$type', '$condition', '$exchange', '$price', '$file_name', '$description')";
    ...
    <div class="container-fluid">
        ...
        <div class="container d-lg-flex flex-lg-row-reverse">
            <!-- Sell Books -->
            <div class="container" id="sellBooks">
                <div class="card mt-3 mx-auto">
                    <div class="card-body">
                        <div class="card-header text-center">
                            <h5 class="card-title">Upload Book Details</h5>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" aria-label="Floating label select example" id="floatingSelect" name="genre">
